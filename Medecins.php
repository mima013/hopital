...
if (isset($_POST['submit'])) {
  ...
  $nom_medecins=htmlspecialchars($_POST['nom']);
  $prenom_medecins=htmlspecialchars($_POST['prenom']);
  $sexe_medecins=htmlspecialchars($_POST['sexe']);
  $adr_medecins=htmlspecialchars($_POST['adr']);
  $tel_medecins=htmlspecialchars($_POST['tel']);
  $fonction=htmlspecialchars($_POST['fonction']);
  
  
  $ins_medecins=$connect->prepare("INSERT INTO `medecins` (`id_medecins`, `nom_medecins`, `prenom_medecins`, `sexe_medecins`, `adr_medecins`, `tel_medecins`, `fonction_medecins`) VALUES (NULL, :nom, :prenom, :sexe, :adr, :tel, :fonction)");
  $ins_medecins->bindParam(':nom' ,$nom_medecins , PDO::PARAM_STR);
  $ins_medecins->bindParam(':prenom' ,$prenom_medecins , PDO::PARAM_STR);
  $ins_medecins->bindParam(':sexe' ,$sexe_medecins, PDO::PARAM_STR);
  $ins_medecins->bindParam(':adr' ,$adr_medecins , PDO::PARAM_STR);
  $ins_medecins->bindParam(':tel' ,$tel_medecins , PDO::PARAM_STR);
  $ins_medecins->bindParam(':fonction' , $fonction , PDO::PARAM_STR);
...
echo "<meta http-equiv='refresh' content='5; url = Medecins.php' />";
